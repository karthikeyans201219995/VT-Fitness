...
## Problem
Frontend at `http://localhost:3000` cannot access backend at `https://gymopspro.preview.emergentagent.com` due to CORS policy.
...
- `https://gymopspro.preview.emergentagent.com` (preview URL)
